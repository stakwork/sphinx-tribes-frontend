...
import { BountiesDescriptionProps } from 'bounties/interfaces';
...
const FeaturedBountyDescription = (props: BountiesDescriptionProps) => {
...
export default FeaturedBountyDescription;
